        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-gray-600 text-white px-6 py-5 rounded-lg"
            >
              Gestion des Devis
            </button>
            <button
              onClick={() => router.push('/admin-realisations')}
              className="bg-blue-600 text-white px-6 py-5 rounded-lg hover:bg-blue-700"
            >
            ...
            <button
              ...
              className="bg-gray-600 text-white px-6 py-5 rounded-lg hover:bg-gray-700"
            >
              Déconnexion
            </button>
          </div>
