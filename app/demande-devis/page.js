...
export default function DemandeDevis() {
  ...
  const jsonLd = {
    ...
    description: 'Demandez votre devis gratuit pour la création de votre site web professionnel. Configurateur en ligne, prix transparent, réponse sous 24h.',
    url: 'https://www.webonlineconcept.com/demande-devis',
    provider: {
      '@type': 'Organization',
    ...
    potentialAction: {
      '@type': 'OrderAction',
      target: 'https://www.webonlineconcept.com/demande-devis',
      result: {
        '@type': 'Order',
  ...
  return (
    <>
      <Head>
        <title>Demande de Devis Site Web Gratuit - Configurateur en Ligne | Web Online Concept</title>
        <meta name="description" content="Configurez votre site web et obtenez un devis gratuit instantané. Formule de base à 500€ + options sur mesure. Réponse garantie sous 24h." />
        <meta name="keywords" content="devis site web gratuit, configurateur site internet, devis création site web, prix site internet personnalisé, devis en ligne site web" />
        <link rel="canonical" href="https://www.webonlineconcept.com/demande-devis" />
        
        <meta property="og:title" content="Demande de Devis Site Web Gratuit - Configurateur en Ligne" />
        <meta property="og:description" content="Configurez votre site web et obtenez un devis gratuit instantané. Formule de base à 500€ + options sur mesure." />
        <meta property="og:url" content="https://www.webonlineconcept.com/demande-devis" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Web Online Concept" />
        <meta property="og:image" content="/images/og-devis.jpg" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Demande de Devis Site Web Gratuit" />
        <meta name="twitter:description" content="Configurez votre site web et obtenez un devis gratuit instantané." />
        <meta name="twitter:image" content="/images/og-devis.jpg" />
      </Head>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          aria-label={`Quantité pour ${option.nom}`}
                        />
                      </div>
                    </div>
                  </div>
