...
export const metadata = {
  title: 'Conditions Générales de Vente - Web Online Concept',
  description: 'CGV de Web Online Concept pour la création de sites web. Modalités de commande, tarifs, paiements, garanties et conditions détaillées.',
  keywords: 'cgv web online concept, conditions générales vente, conditions création site web, cgv site internet, modalités paiement site web',
  openGraph: {
    title: 'Conditions Générales de Vente - Web Online Concept',
    description: 'CGV de Web Online Concept pour la création de sites web. Modalités et conditions détaillées.',
    url: 'https://www.webonlineconcept.com/cgv',
    siteName: 'Web Online Concept',
    locale: 'fr_FR',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.webonlineconcept.com/cgv',
  },
  robots: {
    index: true,
    follow: true,
...
export default function CGV() {
  const jsonLd = {
    ...
    description: 'Conditions Générales de Vente de Web Online Concept',
    url: 'https://www.webonlineconcept.com/cgv',
    publisher: {
      '@type': 'Organization',
