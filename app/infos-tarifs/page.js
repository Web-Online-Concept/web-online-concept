...
export default function InfosTarifs() {
  ...
  const jsonLd = {
    ...
    '@type': 'WebPage',
    name: 'Tarifs et Options - Web Online Concept',
    description: 'Tarifs transparents pour la création de sites web. Site complet à 500€ HT avec options personnalisables selon vos besoins.',
    url: 'https://www.webonlineconcept.com/infos-tarifs',
    provider: {
      '@type': 'Organization',
    ...
    offers: {
      ...
      price: '500',
      priceCurrency: 'EUR',
      description: '5 pages personnalisées, design moderne, SEO de base inclus, hébergement 1 an offert'
    }
  }
  ...
  return (
    <>
      <Head>
        <title>Tarifs Création Site Web - Prix Transparent à 500€ | Web Online Concept</title>
        <meta name="description" content="Découvrez nos tarifs transparents pour la création de sites web professionnels. Site complet à 500€ HT avec options sur mesure. Devis gratuit sous 24h." />
        <meta name="keywords" content="tarifs site web, prix création site internet, tarif site vitrine, cout site web professionnel, prix site internet 500 euros" />
        <link rel="canonical" href="https://www.webonlineconcept.com/infos-tarifs" />
        
        <meta property="og:title" content="Tarifs Création Site Web - Prix Transparent à 500€ | Web Online Concept" />
        <meta property="og:description" content="Découvrez nos tarifs transparents pour la création de sites web professionnels. Site complet à 500€ HT avec options sur mesure." />
        <meta property="og:url" content="https://www.webonlineconcept.com/infos-tarifs" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Web Online Concept" />
        <meta property="og:image" content="/images/og-tarifs.jpg" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Tarifs Création Site Web - Prix Transparent à 500€" />
        <meta name="twitter:description" content="Découvrez nos tarifs transparents pour la création de sites web professionnels." />
        <meta name="twitter:image" content="/images/og-tarifs.jpg" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-6">
              {tarifs.options.map((option) => (
                <article key={option.id} className="bg-white border border-gray-200 rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
